...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - Consumer Registration</title>
...
<body class="bg-gray-100">
    <div class="register-container">
        ...
        <form method="POST" action="{{ route('consumer.register.submit') }}" id="registerForm">
            @csrf
            ...
            <div class="step active" id="step1">
                ...
                <div class="form-group">
                    ...
                    <textarea id="address" class="form-control @error('address') border-red-500 @enderror" name="address" rows="3">{{ old('address') }}</textarea>
                    @error('address')
                        <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="text-center mt-4">
                <p>Already have an account? <a href="{{ route('consumer.login') }}" class="btn-link">Login</a></p>
            </div>
        </form>
    </div>
